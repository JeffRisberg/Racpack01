  ...
  public static void main(String[] args) throws Exception {
    ...
    RatpackServer.start(s -> s
        ...
        .handlers(chain -> chain
            ...
            .prefix("nested",
                nested -> { // Set up a nested routing block, which is delegated to `nestedHandler`
                  nested.path(":var1/:var2?",
                      ctx -> { // The path tokens are the :var1 and :var2 path components above
