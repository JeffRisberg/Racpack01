...
public class CampaignServiceImpl implements CampaignService {
  ...
  public List<Campaign> getCampaigns() {
    try {
      ...
      Campaign c2 = new Campaign("Summer 2016 promotion", false,
          dateF.parse("07/16/2016 12:06:39"));
      Campaign c3 = new Campaign("Fall 2016 promotion", false, dateF.parse("09/16/2016 09:56:34"));
      Campaign c4 = new Campaign("Winter 2017 promotion", false,
          dateF.parse("12/01/2016 14:06:03"));
